 ...
 * Time: 7:51 PM
 */
public class CrackLimitCookieStore implements java.net.CookieStore {
    ...
    private boolean contains(HttpCookie cookie) {
        for (HttpCookie httpCookie : cookieJar) {
