...
public class FilterChainTest {
    ...
    @Test
    public void equals() {
        FilterChain showFaceCollectFilterChain = FilterChainFactory.getShowFaceCollectFilterChain(11);
        FilterVO filterVO = new FilterVO();
        filterVO.setCollect(11);
        filterVO.setTitle("露脸");
        FilterChain filterChain = FilterChainFactory.getFilter(filterVO);
